...
class HospitalDoctorsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Filter doctors by the provided hospital name
    final doctors = MockData.doctors
        .where((d) => d.hospital.toLowerCase() == hospitalName.toLowerCase())
        .toList();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text('${doctors.length} Doctors Registered',
                style: GoogleFonts.poppins(
      ...
      body: doctors.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, i) => _DoctorListCard(doctor: doctors[i]),
            ),
    );
  }
}
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text('PKR ${doctor.fee.toInt()}',
                              style: GoogleFonts.poppins(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w600,
                                  color: AppTheme.primary)),
