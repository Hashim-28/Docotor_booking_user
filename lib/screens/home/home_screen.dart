...
class _HomeScreenState extends State<HomeScreen>
  ...
  Future<void> _openWhatsApp() async {
    final Uri uri = Uri.parse('https://wa.me/923148272532?text=I%20want%20to%20register%20as%20a%20doctor%20on%20DocBook.');
      ...
      body: FadeTransition(
        ...
        child: CustomScrollView(
          slivers: [
            ...
            SliverToBoxAdapter(child: _buildRegisterDoctorBanner()),
                  ...
                  children: [
                    Text('Register as Doctor',
                        style: GoogleFonts.poppins(
                            ...
                            fontSize: 15,
                            fontWeight: FontWeight.w700)),
                    Text('Tap to connect via WhatsApp → 0314-8272532',
                        style: GoogleFonts.poppins(
